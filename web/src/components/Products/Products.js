      ...
      <table className="table-auto w-full min-w-3xl text-sm">
        <thead>
          <tr className="bg-gray-300 text-gray-700">
            ...
            <th className="font-semibold text-left p-3">image alt</th>
        ...
        <tbody>
          {products.map((product) => (
            ...
            >
              ...
              <td className="p-3">{truncate(product.title)}</td>
              <td className="p-3">{truncate(product.description)}</td>
              <td className="p-3">{truncate(product.price)}</td>
              <td className="p-3"><img src={truncate(product.image)} width="150px" alt=""/></td>
              <td className="p-3">{truncate(product.imageAlt)}</td>
